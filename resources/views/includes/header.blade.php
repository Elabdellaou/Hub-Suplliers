                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="{{ route('pages.cart') }}"
                            class="nav-item nav-link {{ Request::is('pages/cart') ? 'active' : '' }}">Shopping Cart</a>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="dropdown nav-item">
                            ...
                            <div class="dropdown-menu" id="menu_language"  style="z-index: 1600;" aria-labelledby="dropdownMenuButton">
                        ...
                        <div class="dropdown nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-left" style="z-index: 1600;" aria-labelledby="dropdownMenuButton">
                                @auth
